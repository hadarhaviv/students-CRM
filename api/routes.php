...
$controllers = array("students" => ["getStudents", "addStudent", "deleteStudent", "editStudent"], "courses" => ["getCourses", "addCourse", "deleteCourse", "editCourse"], "admins" => ["getAdmins", "addAdmin", "editAdmin"], "login" => ["login", "logout", "createHash"]);
